...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['running_products'] = Product::running()->count();
        $widget['upcoming_products'] = Product::upcoming()->count();
        $widget['expired_products'] = Product::expired()->count();

        $widget['total_bids'] = Bid::count();
        $widget['total_winners'] = Winner::count();
        $widget['pending_winners'] = Winner::where('shipping_status', 0)->count();
        $widget['shipped_winners'] = Winner::where('shipping_status', 2)->count();
