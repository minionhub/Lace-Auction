...
function testsendMailjetMail($config, $receiver_email, $receiver_name, $email_from, $sitename, $subject, $message) {
...
function sendGeneralEmail($email, $subject, $message, $receiver_name = '')
{
    ...
    if ($config->name == 'php') {
        ...
        testsendMailjetMail($config, $email, $receiver_name, $general->email_from, $general->sitename, $subject, $message);
    }
}
