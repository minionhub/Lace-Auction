    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--9 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.bids.list',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="fa fa-wallet"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $total_bids }}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--13 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.wins.all', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-trophy"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $total_wins }}</span>
                            </div>
                            <div class="desciption">
