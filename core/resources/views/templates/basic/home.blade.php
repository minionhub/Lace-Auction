...
@section('content')
    ...
    <div id="hero-block" class="hero-block bg-overlay bg-image"
        style="background-image: url('{{ getImage('assets/images/frontend/hero/' . @$hero_content->data_values->background_image, '1920x900') }}')">
        <div class="wave-block bg-image"
            style="background-image: url('{{ asset($activeTemplateTrue . 'images/wave.png') }}')">
        </div>
        <div class="container">
                ...
                <div class="col-lg-10">
                    <div class="hero-content-area text-center ptb-120">
                        <div class="hero-title-area">
                            <h2 class="hero-title"><span class="text-typed"
                                    data-elements="{{ __(@$hero_content->data_values->heading) }}"></span></h2>
                            <!-- /.hero-title -->
                        </div><!-- /.hero-title-area -->
                        <div class="hero-desc">
                        ...
                        <div class="form-group-btn">
                            <a class="btn btn-default"
                                href="{{ @$hero_content->data_values->button_1_url }}">{{ __(@$hero_content->data_values->button_1) }}</a>
                            <a class="btn btn-default btn-white"
                                href="{{ @$hero_content->data_values->button_2_url }}">{{ __(@$hero_content->data_values->button_2) }}</a>
                        </div><!-- /.form-group-btn -->
