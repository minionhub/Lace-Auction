        ...
        <div class="row">
            @foreach($gatewayCurrency as $data)
                <div class="col-lg-3 col-md-3 mb-4">
                    <div class="card card-deposit custom-box-shadow bg-white-smoke">
                        ...
                        <div class="card-footer">
                            <a href="javascript:void(0)" data-id="{{$data->id}}" data-resource="{{$data}}"
                               ...
                               data-percent_charge="{{getAmount($data->percent_charge)}}" class="btn btn-default btn-block custom-success deposit" data-toggle="modal" data-target="#exampleModal">
                                @lang('Deposit Now')</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body custom_border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="amount" type="text" class="form-control form-controller" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" name="amount" placeholder="0.00" required=""  value="{{old('amount')}}">
                                <div class="input-group-prepend">
                                    <span class="input-group-text currency-addon addon-bg bg-white-smoke text-light custom_border_span">{{__($general->cur_text)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
