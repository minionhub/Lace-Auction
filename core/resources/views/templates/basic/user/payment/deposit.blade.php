                ...
                <div class="col-lg-3 col-md-3 mb-4">
                    <div class="card card-deposit custom-box-shadow bg-white-smoke">
                        ...
                        <div class="card-body card-body-deposit">
                            <img src="{{ asset('assets/images/gateway/' . $data->image) }}" class="card-img-top"
                        ...
                        <div class="card-footer">
                            <a href="javascript:void(0)" data-id="{{ $data->id }}" data-resource="{{ $data }}"
                                ...
                                class="btn btn-default btn-block custom-success deposit" data-toggle="modal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <span
                                        class="input-group-text currency-addon addon-bg bg-white-smoke text-light custom_border_span">{{ __($general->cur_text) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
