    ...
    <div class="container ptb-120">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card card-deposit bg-white-smoke custom-box-shadow p-4">
                    ...
                    <div class="card-body card-body-deposit">
                        ...
                        <form role="form" id="payment-form" method="{{$data->method}}" action="{{$data->url}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="tel" class="form-control form-control-lg custom-input"
                                               name="cardNumber" placeholder="@lang('Valid Card Number')"
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control form-control-lg input-sz custom-input"
                                           name="cardExpiry" placeholder="@lang('MM / YYYY')" autocomplete="off"
                                           required/>
                                </div>
                                <div class="col-md-6 ">
                            ...
                            <br>
                            <button class="btn btn-default btn-lg btn-block text-center" type="submit"> @lang('PAY NOW')
                            </button>
