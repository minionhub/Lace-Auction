...
<body>
                                        ...
                                        <ul id="nav">
                                            ...
                                            <li class="dropdown-trigger">
                                                ...
                                                <ul class="dropdown-content">
                                                    <li><a href="{{ route('user.deposit') }}">@lang('Deposit Money')</a>
                                                    </li>
                                                    <li><a
                                            ...
                                            <li><a href="{{ route('user.winning.products') }}">@lang('Winning Products')</a>
                                            </li>
                                            ...
                                            <li class="dropdown-trigger">
                                                ...
                                                <ul class="dropdown-content">
                                                    ...
                                                    <li><a href="{{ route('user.twofactor') }}">@lang('2FA Security')</a>
                                                    </li>
                                                    <li><a href="{{ route('user.logout') }}">@lang('Logout')</a>
                                                    </li>
                                                </ul>
                                            </li>
                                ...
                                <div class="widget-content">
                                    <ul>
                                        ...
                                        @forelse($terms_privacy as $item)
                                            <li>
                                                <a
                                                    href="{{ route('extraPage.details', [$item->id, slug($item->data_values->title)]) }}">
                ...
                <div class="footer-bottom d-flex flex-wrap-reverse justify-content-between align-items-center py-3">
                    <div class="copyright-text text-center">
                        <div class="copyright text-white">
                            ...
                            <p id="serverTime" style="display: none;">{{ $serverTime }}</p>
                        </div>
                    </div>
    ...
    <script>
        ...
        const localTimeStrings = Array.from(bidTimeElements).map((timeElement) => {
            ...
            const adjustedTime = new Date(dateString.getTime() + timeGap);
            ...
            var formattedDate = adjustedTime.toLocaleDateString('en-US', options);
